 ...
 private $rpassword;
    ...
    public function setVariable()
    {
     ...
     /*public function controllo_username(){
       ...
       $con_username = $this -> __construct();
       $x=0;

       //echo $username;
       if(!empty($username)){

             for($i=0; $i<sizeof($con_username); $i++){
               if($con_username[$i][2]==$username)
                 {$x=1;}
    ...
    public function controllo(){
      ...
      echo   $con_name.$con_sirname.$con_email.$con_password.$con_date;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  if(con_names==0){
    ...
    $('#err_name').text("Name is not valid! (musnt contain special characters)");
  }
  if(con_names==2){
    $('#name').removeClass('is-valid');
    $('#name').addClass('is-invalid');
...
////////////////////////////////////////////////////////////////////////////////
  ...
  if(con_sirname==0){
    ...
    $('#err_sirname').text("Sirname is not valid! (musn\'t contain special characters)");
  }
  if(con_sirname==2){
    $('#sirname').removeClass('is-valid');
    $('#sirname').addClass('is-invalid');
    $('#err_sirname').text("insert your Sirname!");
  }
  ///////////////////////////////////////////////////////////////////////////////
  /*  if(con_username==1){
    ...
    if(con_username==2){
      ...
      $('#err_username').text('Insert your username!');
    }
    if(con_username==0){
      $('#username').removeClass('is-valid');
      $('#username').addClass('is-invalid');
      $('#err_username').text('This username is already exist!');
    }*/
///////////////////////////////////////////////////////////////////////////////
  if(con_mail==1){
  ...
  if(con_mail==0){
    ...
    $('#err_email').text('E-mail you inserted is not valid!');
  }
  if(con_mail==2){
    $('#email').removeClass('is-valid');
    $('#email').addClass('is-invalid');
  ...
  if(con_mail==3){
    $('#email').removeClass('is-valid');
    $('#email').addClass('is-invalid');
    $('#err_email').text('This e-mail is already exist!');
  }
///////////////////////////////////////////////////////////////////////////////
  if(con_password==1){
  ...
  if(con_password==0){
    ...
    $('#err_pwd').text('Passwords are not matched!');
  }
  if(con_password==2){
    $('#password, #rpassword').removeClass('is-valid');
    $('#password').addClass('is-invalid');
    $('#rpassword').addClass('is-invalid');
    $('#err_pwd').text('Insert a Passwords!');
  }
///////////////////////////////////////////////////////////////////////////////
  if(con_date==1){
  ...
  if(con_date==0){
    ...
    $('#err_date').text("Insert correct Date!");
    }
  if(con_date==2){
    $('#date').removeClass('is-valid');
      $('#date').addClass('is-invalid');
      $('#err_date').text("Insert a Date!");
    }
